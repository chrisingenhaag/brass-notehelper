...
export const NoteBasesInTrebleClef = new Map<Note, NoteInfo>([
    ["des'''", { staffPosition: -11, accidental: '♭' }],
    ["d'''", { staffPosition: -11 }],
    ["ces'''", { staffPosition: -10, accidental: '♭' }],
    ["c'''", { staffPosition: -10 }],
    ["cis'''", { staffPosition: -10 , accidental: '♯'}],
    ["b''", { staffPosition: -9, accidental: '♭' }],
    ["h''", { staffPosition: -9 }],
    ["his''", { staffPosition: -9 , accidental: '♯'}],
    ["as''", { staffPosition: -8, accidental: '♭' }],
    ["a''", { staffPosition: -8 }],
    ["ais''", { staffPosition: -8 , accidental: '♯'}],
    ["ges''", { staffPosition: -7, accidental: '♭' }],
    ["g''", { staffPosition: -7 }],
    ["gis''", { staffPosition: -7 , accidental: '♯'}],
    ["fes''", { staffPosition: -6, accidental: '♭' }],
    ["f''", { staffPosition: -6 }],
    ["fis''", { staffPosition: -6 , accidental: '♯'}],
    ["es''", { staffPosition: -5, accidental: '♭' }],
    ["e''", { staffPosition: -5 }],
    ["eis''", { staffPosition: -5, accidental: '♯' }],
    ["des''", { staffPosition: -4, accidental: '♭' }],
    ["d''", { staffPosition: -4 }],
    ["dis''", { staffPosition: -4, accidental: '♯' }],
    ["ces''", { staffPosition: -3, accidental: '♭' }],
    ["c''", { staffPosition: -3 }],
    ["cis''", { staffPosition: -3, accidental: '♯' }],
    ["b'", { staffPosition: -2, accidental: '♭' }],
    ["h'", { staffPosition: -2 }],
    ["his'", { staffPosition: -2, accidental: '♯' }],
    ["as'", { staffPosition: -1, accidental: '♭' }],
    ["a'", { staffPosition: -1 }],
    ["ais'", { staffPosition: -1, accidental: '♯' }],
    ["ges'", { staffPosition: 0, accidental: '♭' }],
    ["g'", { staffPosition: 0 }],
    ["gis'", { staffPosition: 0, accidental: '♯' }],
    ["fes'", { staffPosition: 1, accidental: '♭' }],
    ["f'", { staffPosition: 1 }],
    ["fis'", { staffPosition: 1, accidental: '♯' }],
    ["es'", { staffPosition: 2, accidental: '♭' }],
    ["e'", { staffPosition: 2 }],
    ["eis'", { staffPosition: 2, accidental: '♯' }],
    ["des'", { staffPosition: 3, accidental: '♭' }],
    ["d'", { staffPosition: 3 }],
    ["dis'", { staffPosition: 3, accidental: '♯' }],
    ["ces'", { staffPosition: 4, accidental: '♭' }],
    ["c'", { staffPosition: 4 }],
    ["cis'", { staffPosition: 4, accidental: '♯' }],
    ["b", { staffPosition: 5, accidental: '♭' }],
    ["h", { staffPosition: 5 }],
    ["his", { staffPosition: 5, accidental: '♯' }],
    ["as", { staffPosition: 6, accidental: '♭' }],
    ["a", { staffPosition: 6 }],
    ["ais", { staffPosition: 6, accidental: '♯' }],
    ["ges", { staffPosition: 7, accidental: '♭' }],
    ["g", { staffPosition: 7 }],
    ["gis", { staffPosition: 7, accidental: '♯' }],
    ["fes", { staffPosition: 8, accidental: '♭' }],
    ["f", { staffPosition: 8 }],
    ["fis", { staffPosition: 8, accidental: '♯' }],
    ["es", { staffPosition: 9, accidental: '♭' }],
    ["e", { staffPosition: 9 }],
    ["eis", { staffPosition: 9, accidental: '♯' }],
    ["des", { staffPosition: 10, accidental: '♭' }],
    ["d", { staffPosition: 10 }],
    ["dis", { staffPosition: 10, accidental: '♯' }],
    ["ces", { staffPosition: 11, accidental: '♭' }],
    ["c", { staffPosition: 11 }],
    ["cis", { staffPosition: 11, accidental: '♯' }],
]);
...
export const trumpetCombinations: Combination[] = [
    ...
    { note: "c'''", positions: [1] },
    { note: "ces'''", positions: [12] },
    { note: "his''", positions: [1] },
    { note: "h''", positions: [12] },
    { note: "b''", positions: [0] },
    ...
    { note: "g''", positions: [12] },
    { note: "ges''", positions: [23] },
    { note: "fis''", positions: [23] },
    { note: "f''", positions: [0] },
    { note: "fes''", positions: [2] },
    { note: "eis''", positions: [0] },
    { note: "e''", positions: [2] },
    { note: "es''", positions: [1] },
    ...
    { note: "dis'", positions: [1] },
    { note: "d'", positions: [12] },
    { note: "des'", positions: [23] },
    { note: "cis'", positions: [23] },
    { note: "c'", positions: [13] },
    { note: "ces'", positions: [123] },
    { note: "his", positions: [13] },
    { note: "h", positions: [123] },
    { note: "b", positions: [0] },
    { note: "ais", positions: [0] },
    { note: "a", positions: [2] },
    { note: "as", positions: [1] },
    ...
    { note: "fis", positions: [23] },
    { note: "f", positions: [13] },
    { note: "fes", positions: [123] },
    { note: "eis", positions: [13] },
    { note: "e", positions: [123] },
